...
public class WordFilterUtil {
	...
	static {
		...
		try {
			Reader re = Resources.asCharSource(Resources.getResource("words.dict"), Charsets.UTF_8).openStream();
	...
	public static void main(String[] args){
		FilteredResult cc = WordFilterUtil.filterText("黄色网站时候发减肥减肥减肥", '*');
		System.out.println(cc.getFilteredContent());
