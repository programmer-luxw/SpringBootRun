...
public class RSAXUtils {
    ...
    private static void baseTest() throws Exception{
        ...
        byte[] encodedData = RSAXUtils.encryptByPublicKey(data, publicKey);
        System.out.println("加密后文字-------------" + encode(encodedData));

        // 解密
        byte[] decodedData = RSAXUtils.decryptByPrivateKey(encodedData, privateKey);
    ...
    private static void signDemo() throws Exception{
       ...
       // String operatorReport = HttpUtils.doGet("http://hzedcom.oss-cn-shenzhen.aliyuncs.com/rong360/bada0ff5-758b-4a51-9bb4-b3b2c14489ee.txt");

        Map<String, Object> bizData = new HashMap<>();

        bizData.put("name", "张三");
        bizData.put("id_number", "1111");
        bizData.put("phone", "13312312411");
        bizData.put("report", "");
        ...
        System.err.println("签名-------------begin=" + begin);
        String sign = RSAXUtils.sign(paramsStr.getBytes(), privateKey);
        long end = System.currentTimeMillis();
        System.err.println("签名-------------" + sign );
        System.err.println("签名-------------花费时间=" + (end - begin) + "ms");
